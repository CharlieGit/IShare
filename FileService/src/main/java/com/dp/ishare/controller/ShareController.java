...
public class ShareController {
    ...
    public ApiResult<UserListResponse> getUserList(String userId){
        ...
        User user1 = new User("zhangsan", "1.1.1.1", new Date(), "aaa.txt", "http://baidu.com");
        User user2 = new User("lisi", "2.2.2.2", new Date(), null, null);
    ...
    public ApiResult<String> sendFile(String fromUserId, String toUserId, String fileName, String fileUrl){
        // write DB
